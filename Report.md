...
### Factors Correlated with Stress: Covid-19
To address the question of how the Covid-19 pandemic affects people’s stress level and how they are related, we can use the application to explore the educational stress dataset. For example, the visualizations below demonstrate that students, including those who have already studied in a virtual environment prior to the pandemic, experience a general increase in stress level. 
![](img/report/final_4a.png)
![](img/report/final_4b.png)

The majority of respondents claim that they experienced negative changes in friend relationships after the pandemic. A natural follow-up question to ask is whether it is associated with increased classwork stress. From the correlation value of -0.08 and heatmap below, we can see that there is no strong correlation between them. 
![](img/report/final_5.png)

To illustrate how the pandemic affects different groups of people, we will look at educational background. While those with the fewest years of education (None) have a bell-shaped distribution of stress level, those with the highest level of education (PhD/Doctorate) have a right-skewed distribution and thus less stress overall.
![](img/report/final_6a.png)
![](img/report/final_6b.png)

The scatter plot of stress and social provision scale can be used to investigate the relationship of stress level and ability of social provision when other dimensions are considered. For instance, we can observe a negative correlation between stress and social provision, with unemployed accounting for less than 10% of the population. However, if we select the range of people with highest perceived stress and lowest social provision scale, the percentage of “not employed” people increased drastically to 23%. Thus, users can investigate the correlation while also taking into account other dimensions.
...
[19] Our dataset will be made available at http://www.cs.columbia.edu/˜eturcan/data/dreaddit.zip.

[20] S. M. Al Faruqui. (2021). “Mental Health Survey”. Retrieved from: https://www.kaggle.com/datasets/faruqui682/mental-health-survey
